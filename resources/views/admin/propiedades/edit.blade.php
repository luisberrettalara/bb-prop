...
<div class="py-4 publicacion">
    <div class="row justify-content-center">
        <div class="col-md-9">
            ...
            <form id="propiedad" method="POST" action="{{ route('admin.propiedades.update', $propiedad->id) }}" class="form-disable" rl="upload" files="true" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                <div class="card card-publicacion">
                    ...
                    <div class="card-body interchangeable" id="datos">
                        <div class="form-group"> 
                            ...
                            <input type="text" id="usuarios-autocompletar" class="form-control" value="{{old('usuario-email', $propiedad->usuario->email)}}" autofocus> 
                            <input type="hidden" name="usuario" id="usuarios-id" value="{{old('usuario', $propiedad->usuario->id)}}">  
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <select id="tipologia_id" type="text" class="form-control{{ $errors->has('tipologia_id') ? ' is-invalid' : '' }}" name="tipologia_id" value="{{ old('tipologia_id') }}">
                        ...
                        <div class="dropzone mb-4" id="myDropzone">
                           <div class="dz-message" data-dz-message>
                              <span>Suba o arrastre fotos aquí</span>
                           </div>
                        </div> 
                        <div class="form-group">
                    ...
                    <div class="card-body d-none interchangeable" id="ubicacion">
                        ...
                        <div class="form-group">
                            <label for="localidad_id" class="form-label"><strong>Localidad</strong></label>
                                <input id="localidad_id" class="form-control{{ $errors->has('localidad_id') ? ' is-invalid' : '' }}" name="localidad_id" type="text" value="{{ old('localidad_id', $propiedad->localidad->nombre) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="barrios-autocompletar" class="form-control{{ $errors->has('barrio_id') ? ' is-invalid' : '' }}" name="barrio-nombre" value="{{ old('barrio-nombre', $propiedad->barrio) }}">
                        ...
                        <div class="form-group">
                            <label for="direccion" class="form-label"><strong>Dirección</strong></label>
                                <input id="direccion" type="text" class="form-control{{ $errors->has('direccion') ? ' is-invalid' : '' }}" name="direccion" value="{{ old('direccion', $propiedad->direccion) }}">
                        ...
                        <div class="form-group">
                            <label for="piso" class="form-label"><strong>Piso (opcional)</strong></label>
                                <input id="piso" type="text" class="form-control{{ $errors->has('piso') ? ' is-invalid' : '' }}" name="piso" value="{{ old('piso',$propiedad->piso) }}">
                        ...
                        <div class="form-group">
                            <label for="departamento" class="form-label"><strong>Departamento (opcional)</strong></label>
                                <input id="departamento" type="text" class="form-control {{ $errors->has('departamento')?'is-invalid':''}}"  name="departamento" value="{{ old('departamento',$propiedad->departamento) }}">
                        ...
                        <div class="form-group">
                            <label for="referencia" class="form-label"><strong>Referencia (opcional)</strong></label>
                                <input id="referencia" type="text" class="form-control {{ $errors->has('referencia')?'is-invalid':''}}"  name="referencia" value="{{ old('referencia', $propiedad->referencia) }}">
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline custom-control custom-checkbox">
                                <input type="checkbox" name="ubicacion_publica" class="custom-control-input" value="1" {{old('ubicacion_publica', $propiedad->ubicacion_publica) ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right change-card" data-ref="#caracteristicas" data-step="paso-3">
                                <a href="#" class="btn btn-info">Siguiente</a>
                            </div>
                        </div>
                    </div>
