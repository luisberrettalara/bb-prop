...
<div class="py-4">
	<div class="row justify-content-center">
		<div class="col-md-5 col-12">
			<form method="POST" action="{{ route('admin.barrios.store') }}" role="form" autocomplete="off">
			@csrf
				<div class="card">
                  ...
                  <input id="localidad_id" type="text" class="form-control{{ $errors->has('localidad') ? ' is-invalid' : '' }}" name="localidad" value="{{ old('localidad') }}" autocomplete="off">
                  <ul id="predicciones_localidad" class="menu-predicciones">
                  </ul>
                  ...
                  @endif
								...
								<div class="form-group">
									...
									<input type="text" name="nombre" id="nombre" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" value="{{ old('nombre') }}" autocomplete="off">
                    ...
                    <span class="invalid-feedback" role="alert">
			            ...
			            @endif
								...
								<input id="loc_place_id" type="hidden" name="loc_place_id">
							</div>
						</div>
					</div>
