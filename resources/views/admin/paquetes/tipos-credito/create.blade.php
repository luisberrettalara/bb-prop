...
<div class="py-4">
  <div class="row justify-content-center">
    <div class="col-md-5 col-12">
      <form method="POST" action="{{ route('admin.tipos-credito.store') }}" role="form">
      @csrf
        <div class="card">
          <div class="card-header">
            <h4>Nuevo Tipo de Crédito</h4>
          </div>
          <div class="card-body">
            <div class="form-group">
              <label for="duracion_en_dias">Duración en días</label>
              <input type="number" min="1" max="9999" step="1" name="duracion_en_dias" id="duracion_en_dias" class="form-control{{ $errors->has('duracion_en_dias') ? ' is-invalid' : '' }}" value="{{ old('duracion_en_dias') }}">
            ...
            <div class="form-group">
              ...
              <input type="number" min="1" max="9999" step="1" name="dias_al_vencimiento" id="dias_al_vencimiento" class="form-control{{ $errors->has('dias_al_vencimiento') ? ' is-invalid' : '' }}" value="{{ old('dias_al_vencimiento') }}">
