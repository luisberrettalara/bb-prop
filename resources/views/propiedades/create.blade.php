...
@section('content')
<form id="propiedad" method="POST" action="{{ route('propiedades.store') }}" class="form-disable" url="upload" files="true" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card card-publicacion">
                    ...
                    <div class="card-body interchangeable" id="datos">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <div class="form-check form-check-inline custom-control custom-checkbox">
                                        <input id="precio_convenir" type="checkbox" name="precio_convenir" class="custom-control-input" value="1" {{old('precio_convenir') ? 'checked' : ''}}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text"  name="video_url" placeholder="https://www.youtube.com/..." class="form-control">
                    ...
                    <div class="card-body d-none interchangeable" id="ubicacion">
                        ...
                        <div class="form-group">
                            <label for="piso" class="form-label"><strong>Piso (opcional)</strong></label>
                                <input id="piso" type="texts" class="form-control{{ $errors->has('piso') ? ' is-invalid' : '' }}" name="piso" value="{{ old('piso') }}">
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline custom-control custom-checkbox">
                                <input type="checkbox" name="ubicacion_publica" class="custom-control-input" value="1" {{old('ubicacion_publica') ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            <div class="col-md-9 col-4-12 text-md-right text-center change-card" data-ref="#datos" data-step="paso-1">
